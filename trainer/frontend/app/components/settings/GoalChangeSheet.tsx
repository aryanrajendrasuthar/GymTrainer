        ...
        >
          <AnimatePresence mode="wait">
            {!showSplitNudge ? (
              ...
              >
                {/* Nudge Header */}
                <div className="px-5 pt-12 pb-4 border-b border-white/8 shrink-0">
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-base font-bold text-white">Update Your Split</p>
                    <button
                  ...
                  <div className="flex items-start gap-3 bg-amber-500/10 border border-amber-500/25 rounded-[14px] p-3.5">
